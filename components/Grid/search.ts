...
// LRU cache — 32 entries covers typical type-ahead depth. Keyed on
// `query|limit` so backspace/corrections hit cache instantly.
const searchCache = new Map<string, Scored[]>()
const CACHE_MAX = 32
